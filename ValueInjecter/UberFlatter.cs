...
namespace Omu.ValueInjecter
{
    ...
    {
        public static IEnumerable<PropertyWithComponent> Unflat(string flatPropertyName, object target, Predicate<Type> f, StringComparison comparison)
        {
        ...
        public static IEnumerable<PropertyWithComponent> Unflat(string flatPropertyName, object target, Predicate<Type> f)
        {
        ...
        public static IEnumerable<PropertyWithComponent> Flat(string flatPropertyName, object source, Predicate<Type> f)
        {
            return Flat(flatPropertyName, source, f, StringComparison.Ordinal);
        }

        public static IEnumerable<PropertyWithComponent> Flat(string flatPropertyName, object source, Predicate<Type> f, StringComparison comparison)
        {
            var trails = TrailFinder.GetTrails(flatPropertyName, source.GetType().GetInfos(), f, comparison);

            return trails.Select(trail => Tunnelier.GetPropertyWithComponent(trail, source));
        }
