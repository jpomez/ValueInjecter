...
namespace Tests
{
    ...
    public class UberFlatterTests
    {
        ...
        {
            var l = TrailFinder.GetTrails("TheFooBarName", typeof(Unflat).GetInfos().Single(o => o.Name == "The"), o => o == typeof(string), new Queue<string>(new List<string>()), StringComparison.Ordinal).ToList();
            l.Count.IsEqualTo(2);
        }
